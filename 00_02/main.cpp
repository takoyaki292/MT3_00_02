...
Matrix4x4 Inverse(const Matrix4x4& m)
{
	...
	r.m[1][3] = (m.m[0][0] * m.m[1][2] * m.m[2][3]
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		MatrixScreenPrintf(kColmnWidht * 5, 0, transposeM1);
		MatrixScreenPrintf(kColmnWidht * 5, kRowHeight * 5, transposeM2);
		MatrixScreenPrintf(kColmnWidht * 5, kRowHeight * 5 * 2, identity);
		///
		/// ↑描画処理ここまで
		///
